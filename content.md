...
// can't yet format InlineHtmlBlock ("[Some Text](some-file.md)
", None, None) to pynb markdown

becomes

// can't yet format InlineHtmlBlock ("[Some Text](some-file.html)
", None, None) to pynb markdown
...
external link. ", Some { StartLine = 168 StartColumn = 2 EndLine = 169 EndColumn = 127 }); DirectLink ([Literal ("Please report it", Some { StartLine = 168 StartColumn = 127 EndLine = 169 EndColumn = 143 })], "https://github.com/fsprojects/FSharp.Formatting/issues/new", None, Some { StartLine = 168 StartColumn = 127 EndLine = 169 EndColumn = 96 }); Literal (".", Some { StartLine = 168 StartColumn = 127 EndLine = 169 EndColumn = 128 })], Some { StartLine = 168 StartColumn = 2 EndLine = 168 EndColumn = 111 })], Some { StartLine = 168 StartColumn = 0 EndLine = 168 EndColumn = 111 }) to pynb markdown
